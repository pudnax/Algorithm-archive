...
template <typename Iter> void dft(Iter X, Iter last) {
  const auto N = last - X;
...
template <typename Iter> void sort_by_bit_reverse(Iter first, Iter last) {
...
template <typename Iter> void iterative_cooley_tukey(Iter first, Iter last) {
