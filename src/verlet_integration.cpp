...
int main() {
  ...
  std::cout << "Time for Verlet integration is: " << time << std::endl;

  timestep timestep_sv = stormer_verlet(5.0, -10, 0.01);
  std::cout << "Time for Stormer Verlet integration is: " << timestep_sv.time
            << std::endl;
  std::cout << "Velocity for Stormer Verlet integration is: " << timestep_sv.vel
            << std::endl;

  timestep timestep_vv = velocity_verlet(5.0, -10, 0.01);
  std::cout << "Time for velocity Verlet integration is: " << timestep_vv.time
            << std::endl;
